    ...
    switch opt.xyOri
        case 'normal'
            if any(opt.showMM==[1,2])
                mh = plot(ah,opt.xValues+xOffset,m,'+k','Color','k','MarkerSize',9,'LineWidth',1.5);
            end
            if any(opt.showMM==[1,3])
                mdh = plot(ah,opt.xValues+xOffset,md,'xk','MarkerSize',9,'LineWidth',1.5);
            end
            if opt.showMM == 4
        ...
        case 'flipped'
            if any(opt.showMM==[1,2])
                mh = plot(ah,m,opt.xValues+xOffset,'+k','Color','k','MarkerSize',9,'LineWidth',1.5);
            end
            if any(opt.showMM==[1,3])
                mdh = plot(ah,md,opt.xValues+xOffset,'xk','MarkerSize',9,'LineWidth',1.5);
            end
            if opt.showMM == 4
